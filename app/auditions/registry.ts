...
export const INTRO: Record<string, string> = {
  ...
  story: "The picked range is now a STORY — we’re building it. Scrub the crossing (the world-moments); at each, the SUBRANGE shows the BEATS that can live there — a cozy one and an intense one, free to run with or against the surrounding. This is the content: a BEAT = a scene realized at a tone.",
};
